        ...
        <div className="fixed bottom-0 inset-x-0 z-50 p-4 md:p-6">
            <div className="max-w-3xl mx-auto bg-bg-elevated border border-border rounded-lg shadow-lg p-5 md:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <div className="flex-1">
                    <p className="text-sm font-semibold text-text-primary mb-1">Cookies</p>
                    <p className="text-xs text-text-secondary leading-relaxed">
                        Ce site utilise des cookies essentiels (panier, session) et des cookies analytics (Umami) pour mesurer l'audience. Aucun cookie publicitaire n'est utilisé.
                    </p>
                </div>
