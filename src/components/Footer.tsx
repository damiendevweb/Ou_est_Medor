export const Footer = () => {
    ...
    return (
        ...
        <footer className="bg-yellow-100">
            <div className="max-w-7xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                    <div>
                        <h3 className="mb-6 text-sm font-semibold text-dark-grey uppercase dark:text-white">Company</h3>
                    ...
                    <div>
                        <h3 className="mb-6 text-sm font-semibold text-dark-grey uppercase dark:text-white">Help center</h3>
                        <ul className="text-black dark:text-gray-400">
                            <li className="mb-4">
                    ...
                    <div>
                        <h3 className="mb-6 text-sm font-semibold text-dark-grey uppercase dark:text-white">Legal</h3>
                        <ul className="text-black dark:text-gray-400">
                            <li className="mb-4">
                    ...
                    <div>
                        <h3 className="mb-6 text-sm font-semibold text-dark-grey uppercase dark:text-white">Download</h3>
                        <ul className="text-black dark:text-gray-400">
                            <li className="mb-4">
                ...
                <div className="text-center">
                    <span className="block text-sm text-center text-black dark:text-gray-400">© 2026 Où est Médor. All Rights Reserved.
                    </span>
                    <ul className="flex justify-center mt-5 space-x-5">
                        <li>
                            <a href="#" className="text-black hover:text-dark-grey dark:hover:text-white dark:text-gray-400">
